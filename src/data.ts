...
export const FAQS_DATA: FaqItem[] = [
  ...
  },
  {
    ...
    a: "Yes. In fact, most GupTech engagements are cross-pillar. A typical product launch blends 'Websites & Tech Setup' (01) for your core website, 'Creative Design & Branding' (03) for branding, and 'Marketing & Customer Growth' (02) for attracting customers."
  },
  {
